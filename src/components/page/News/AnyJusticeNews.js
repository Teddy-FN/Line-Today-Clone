...
function AnyJusticeNews() {
    ...
    useEffect(() => {
        axios.get('/id/portaljson')
            .then((res) => {
                console.log('NEWS', res.data.result.categories[2].templates[15].sections[0].articles)
                setHotNews(res.data.result.categories[2].templates[15].sections[0].articles)
            })
