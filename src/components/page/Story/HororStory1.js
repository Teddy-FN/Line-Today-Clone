    ...
    useEffect(() => {
        axios.get('/id/portaljson')
            .then((res) => {
                ...
                setArticle(res.data.result.categories[12].templates[7].sections[0].articles)
            })
    }, [])
    return (
        <div>
            <div className="card-article">
                <div className="header-card-logo hot-issue">
                    <h4>HOROR: KUALAT GUNUNG PULOSARI</h4>
                </div>
