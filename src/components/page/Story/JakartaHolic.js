    ...
    useEffect(() => {
        axios.get('/id/portaljson')
            .then((res) => {
                ...
                setArticle(res.data.result.categories[12].templates[20].sections[0].articles)
            })
    }, [])
        ...
        <div>
            <div className="cards-article">
                <div className="title-article">
                    <h4>Jakartaholic by Dita Soedarjo</h4>
                </div>
