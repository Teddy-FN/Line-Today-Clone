    ...
    useEffect(() => {
        axios.get('/id/portaljson')
            .then((res) => {
                ...
                setArticle(res.data.result.categories[12].templates[14].sections[0].articles)
            })
    }, [])
        ...
        <div>
            <div className="cards-article">
                <div className="title-article">
                    <h4>LINE TODAY WRITING CONTEST</h4>
                </div>
