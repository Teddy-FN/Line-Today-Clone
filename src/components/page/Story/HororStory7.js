    ...
    useEffect(() => {
        axios.get('/id/portaljson')
            .then((res) => {
                ...
                setArticle(res.data.result.categories[12].templates[21].sections[0].articles)
            })
    }, [])
    return (
        <div>
            <div className="card-article">
                <div className="header-card-logo hot-issue">
                    <h4>Cerita Horor: Sekolah Angker</h4>
                </div>
